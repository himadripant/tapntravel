...
insert into zone_fare(id, zone_from, zone_to, bus_company_id, price) values(3, 1, 3, 1, 5);
insert into zone_fare(id, zone_from, zone_to, bus_company_id, price) values(4, 2, 1, 1, 3.50);
insert into zone_fare(id, zone_from, zone_to, bus_company_id, price) values(5, 2, 2, 1, 3.50);
insert into zone_fare(id, zone_from, zone_to, bus_company_id, price) values(6, 2, 3, 1, 3.75);
insert into zone_fare(id, zone_from, zone_to, bus_company_id, price) values(7, 3, 1, 1, 5);
insert into zone_fare(id, zone_from, zone_to, bus_company_id, price) values(8, 3, 2, 1, 3.75);
insert into zone_fare(id, zone_from, zone_to, bus_company_id, price) values(9, 3, 3, 1, 5.5);

insert into zone_fare(id, zone_from, zone_to, bus_company_id, price) values(10, 1, 1, 2, 2.50);
insert into zone_fare(id, zone_from, zone_to, bus_company_id, price) values(11, 1, 2, 2, 3.50);
insert into zone_fare(id, zone_from, zone_to, bus_company_id, price) values(12, 1, 3, 2, 5);
insert into zone_fare(id, zone_from, zone_to, bus_company_id, price) values(13, 2, 3, 2, 3.75);